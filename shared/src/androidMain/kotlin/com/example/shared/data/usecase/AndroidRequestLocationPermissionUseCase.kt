...
class AndroidRequestLocationPermissionUseCase(
            ...
            try {
                permissionLauncher = activity.activityResultRegistry.register(
                    ...
                    if (granted) {
                        ...
                        val shouldShowRationaleFine = activity.shouldShowRequestPermissionRationale(fineLocationPermission)
                        val shouldShowRationaleCoarse = activity.shouldShowRequestPermissionRationale(coarseLocationPermission)
                        
                        logger.debug(TAG, "Permission denied. Show rationale - Fine: $shouldShowRationaleFine, Coarse: $shouldShowRationaleCoarse")
